#ifndef PRISMDRAFT_CORE_PD_CORE_FACE_INSET_CONTROLLER_H
#define PRISMDRAFT_CORE_PD_CORE_FACE_INSET_CONTROLLER_H
...
#define PD_CORE_FACE_INSET_CONTROLLER_MAX_FACE_EDGES 64u
