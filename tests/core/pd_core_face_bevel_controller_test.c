...
static int pd_core_face_bevel_controller_test_local_near(float left, float right)
{
...
static void pd_core_face_bevel_controller_test_local_bevels_cube_front_face(void)
{
...
static void pd_core_face_bevel_controller_test_local_rejects_invalid_arguments(void)
{
    PdCoreMeshEntity mesh_entity = { 0 };

    assert(pd_core_cube_fixture_build(&mesh_entity) == PD_CORE_RESULT_OK);
    assert(pd_core_face_bevel_controller_apply(0, 1u, 0.25f, 0.2f) == PD_CORE_RESULT_ERROR_INVALID_ARGUMENT);
    assert(pd_core_face_bevel_controller_apply(&mesh_entity, PD_CORE_MESH_ENTITY_INVALID_INDEX, 0.25f, 0.2f) ==
           PD_CORE_RESULT_ERROR_INVALID_ARGUMENT);
    assert(pd_core_face_bevel_controller_apply(&mesh_entity, 1u, 0.0f, 0.2f) ==
           PD_CORE_RESULT_ERROR_INVALID_ARGUMENT);
    assert(pd_core_face_bevel_controller_apply(&mesh_entity, 1u, 0.25f, 0.0f) ==
           PD_CORE_RESULT_ERROR_INVALID_ARGUMENT);
...
int main(void)
{
    pd_core_face_bevel_controller_test_local_bevels_cube_front_face();
    pd_core_face_bevel_controller_test_local_rejects_invalid_arguments();
    return 0;
}
